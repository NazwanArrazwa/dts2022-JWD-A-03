...
<body>
    ...
    <?php
        if(isset($_POST['submit'])){
            ...
            // menghitung bilangan
            if ($bil1 == $bil2) {
                echo "Bilangan A Sama dengan Bilangan B<br/>";
                echo "Bilangan A = $bil1<br/>";
                echo "Bilangan B = $bil2<br/>";
            } else if($bil1 > $bil2) {
                echo "Bilangan A lebih besar dari pada bilangan B<br/>";
                echo "Bilangan A = $bil1<br/>";
                echo "Bilangan B = $bil2<br/>";
            } else if($bil2 > $bil1) {
                echo "Bilangan B lebih besar dari pada bilangan A<br/>";
                echo "Bilangan A = $bil1<br/>";
                echo "Bilangan B = $bil2<br/>";
            }
            return;
